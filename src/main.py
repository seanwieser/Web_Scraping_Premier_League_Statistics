...
if __name__ == "__main__":
    ...
    # analyzer.plot_multi_scatter(['Forward', 'Midfielder'], 'Goals', 'Assists', per=True, top=False, minimum=10, alpha=0.3)
    # analyzer.plot_multi_scatter(['Forward', 'Midfielder'], 'Passes per Game', 'Assists')

    analyzer.stat_hyp_test(['Forward', 'Midfielder'], 'Assists', minimum=10)
